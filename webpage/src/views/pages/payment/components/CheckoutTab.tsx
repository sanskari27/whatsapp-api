...
const Checkout = forwardRef<CheckoutRef, CheckoutProps>(({ isHidden }: CheckoutProps, ref) => {
		...
		<Box hidden={isHidden}>
			...
			>
				...
				<Flex width={'full'} justifyContent={'space-between'}>
					...
					<Text className='text-black dark:text-white'>{transaction[TRANSACTION_DETAIL.TAX]}</Text>
				</Flex>
