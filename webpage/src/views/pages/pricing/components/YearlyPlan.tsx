		...
		>
			...
			>
				...
				<Button
					...
					onClick={() => navigate(`${ROUTES.PRICING}/${BILLING_PLANS_TYPE.SILVER_YEAR}`)}
				>
					Upgrade to Silver
				</Button>
			</Box>
			...
			>
				...
				<Button
					...
					onClick={() => navigate(`${ROUTES.PRICING}/${BILLING_PLANS_TYPE.GOLD_YEAR}`)}
				>
					Upgrade to Gold
				</Button>
			</Box>
			...
			>
				...
				<Button
					...
					onClick={() => navigate(`${ROUTES.PRICING}/${BILLING_PLANS_TYPE.PLATINUM_YEAR}`)}
				>
					Upgrade to Platinum
				</Button>
			</Box>
