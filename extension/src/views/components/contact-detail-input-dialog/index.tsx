...
const ContactDetailInputDialog = ({
	...
	const addContactLinks = () => {
		...
		setContact({
			...contact,
			links: [...contact.links, `https://${contactLinks}`],
		});
		setContactLinks('');
	};
	...
	const addContactOthers = () => {
		...
		setContact({
			...contact,
			contact_number_other: [...contact.contact_number_other, contactOthers],
		});
		setContactOthers('');
	};
	...
	return (
		...
		>
			...
			>
				...
				<ModalFooter>
					<Button width={'full'} colorScheme='green' onClick={() => onConfirm(contact)} size={'sm'}>
						Add Contact
					</Button>
				</ModalFooter>
			</ModalContent>
