...
const CreateLinkDrawer = forwardRef<
    CreateLinkDrawerHandle,
...
>((props: CreateLinkDrawerProps, ref) => {
    ...
    const {
        create_details: { link, message, number, title },
                ...
                <DrawerBody>
                    ...
                    >
                        ...
                        <FormControl isInvalid={error === 'NUMBER'}>
                            ...
                            >
                                Make sure you include the country code followed
                                by the area code eg. for india 91, for UK 44
                            </FormHelperText>
                        </FormControl>
                        <FormControl isInvalid={error === 'MESSAGE'}>
                            <FormLabel
                                textColor={theme === 'dark' ? 'white' : 'black'}
                            >
                                What message do you want your customer to see
