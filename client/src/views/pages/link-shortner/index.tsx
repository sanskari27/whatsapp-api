...
import {
    ...
    setMessage,
    setNumber,
} from '../../../store/reducers/LinkShortnenrReducers';
...
const LinkShortner = () => {
    ...
    const { link, message, number, list } = useSelector(
        (state: StoreState) => state[StoreNames.LINK]
    );
    ...
    const generateQrCode = async () => {
        ...
        ShortenerService.getShortenedURL(number, message).then((res) => {
