	...
	return (
		...
		>
			...
			>
				...
				<DrawerHeader>{isUpdating ? 'Update' : 'Create'} Contact</DrawerHeader>
					...
					<VStack width={'full'} alignItems={'stretch'} gap={4}>
						...
						<Box>
							...
							<Input
								...
								onChange={(e) => dispatch(setEmailPersonal(e.target.value))}
							/>
						</Box>
						<Box>
							...
							<Input
								...
								type='email'
								value={email_work ?? ''}
								onChange={(e) => dispatch(setEmailWork(e.target.value))}
							/>
						</Box>
						<Box>
							...
							<InputGroup bgColor={'transparent'} borderWidth={'1px'} rounded={'md'}>
								<InputLeftAddon
									...
									children={
										<CountryCodeInput
											value={contact_details_phone?.country_code ?? ''}
											onChange={(text) => {
												updateContactNumber('PHONE', 'country_code', text);
											}}
										/>
									}
								/>
						...
						<Box>
							...
							<InputGroup bgColor={'transparent'} borderWidth={'1px'} rounded={'md'}>
								<InputLeftAddon
									...
									children={
										<CountryCodeInput
											value={contact_details_work?.country_code ?? ''}
											onChange={(text) => {
												updateContactNumber('WORK', 'country_code', text);
											}}
										/>
									}
								/>
						...
						<Box>
							<HStack justifyContent={'space-between'} width={'full'} pb={'1rem'}>
									...
									<HStack pb={4} key={index}>
										<InputGroup bgColor={'transparent'} borderWidth={'1px'} rounded={'md'}>
											<InputLeftAddon
												...
												children={
													<CountryCodeInput
														...
														onChange={(text) => {
															updateContactNumber('OTHER', 'country_code', text, index);
														}}
													/>
												}
											/>
											<Input
												...
												name='number'
												onChange={(e) => {
													updateContactNumber('OTHER', 'number', e.target.value, index);
												}}
											/>
										</InputGroup>
										...
										<IconButton
											...
											outline={'none'}
											onClick={() => {
												dispatch(removeContactNumberOther(index));
											}}
										/>
									</HStack>
								);
						...
						<Button
							...
							variant={'outline'}
							onClick={() => {
								locationInputDialog.current?.open();
							}}
						>
