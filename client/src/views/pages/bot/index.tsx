import { Box, Button, Flex, FormControl, FormErrorMessage, HStack, Text } from '@chakra-ui/react';
...
import AllResponders from './componets/AllResponders';
import { NumberInput, SelectElement, TextAreaElement } from './componets/Inputs';
...
export default function Bot() {
	...
	function validate() {
		...
		if (!message && attachments.length === 0 && shared_contact_cards.length === 0) {
			...
			errorPayload.error = 'Message or Attachment or Contact Card is required';
			dispatch(setError(errorPayload));
			hasError = true;
		} else {
			errorPayload.type = 'messageError';
