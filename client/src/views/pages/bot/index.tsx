...
import PollInputDialog, {
    PollInputDialogHandle,
} from '../../components/polls-input-dialog';
...
export default function Bot() {
    ...
    function validate() {
        ...
        if (all_bots.map((bot) => bot.trigger).includes(trigger)) {
        ...
        if (
            ...
            errorPayload.error =
                'Message or Attachment or Contact Card or Poll is required';
            dispatch(setError(errorPayload));
            notHasError = false;
        } else {
            errorPayload.type = 'messageError';
                        ...
                        <FormControl isInvalid={!!ui.triggerGapError} flex={1}>
                            ...
                            <HStack>
                                ...
                                <SelectElement
                                    ...
                                    onChangeText={(text) =>
                                        dispatch(setTriggerGapType(text))
                                    }
                                    options={[
                                        {
                                            value: 'SEC',
                        ...
                        <FormControl isInvalid={!!ui.responseGapError} flex={1}>
                            ...
                            <HStack>
                                <NumberInput
                                    ...
                                    onChangeText={(text) =>
                                        dispatch(setResponseDelayTime(text))
                                    }
                                />
                                <SelectElement
                                    value={response_delay.type}
                                    onChangeText={(text) =>
                                        dispatch(setResponseDelayType(text))
                                    }
                                    options={[
                                        {
                                            value: 'SEC',
                    ...
                    <HStack>
                        ...
                        <Box flex={1}>
                            ...
                            <Button
                                ...
                                colorScheme="green"
                                onClick={() =>
                                    contactSelectorRef.current?.open(
