...
const AttachmentPage = () => {
    ...
    const AttachmentDetailsInputRef =
        React.useRef<AttachmentDetailsInputDialogHandle>(null);
                            ...
                            <Tr key={index}>
                                <Td>
                                    <Checkbox
                                        colorScheme="green"
                                        mr={2}
                                        isChecked={selectedAttachments.includes(
                                            attachment.id
                                        )}
                                        onChange={() =>
                                            addRemoveSelectedAttachments(
                                                attachment.id
                                            )
                                        }
                                    />
