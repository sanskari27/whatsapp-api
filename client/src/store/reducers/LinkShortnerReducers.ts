...
const LinkShortenerReducer = createSlice({
    ...
    reducers: {
        ...
        setLink: (
            state,
            action: PayloadAction<typeof initialState.create_details.link>
        ) => {
        ...
        setNumber: (
            state,
            action: PayloadAction<typeof initialState.create_details.number>
        ) => {
            state.create_details.number = action.payload;
        },
        setMessage: (
            state,
            action: PayloadAction<typeof initialState.create_details.message>
        ) => {
        ...
        addShortenLink: (
            state,
            action: PayloadAction<(typeof initialState.list)[number]>
        ) => {
            state.create_details = initialState.create_details;
        ...
        setGenerated: (
            ...
            state.generation_result.generated_link =
                action.payload.generated_link;
            state.generation_result.generated_image =
                action.payload.generated_image;
        },
        ...
        setGeneratingLink: (
            state,
            action: PayloadAction<typeof initialState.ui.generating_link>
        ) => {
            state.ui.generating_link = action.payload;
        },
        setShortingLink: (
            state,
            action: PayloadAction<typeof initialState.ui.shortening_link>
        ) => {
            state.ui.shortening_link = action.payload;
        },
        setTitle: (
            state,
            action: PayloadAction<typeof initialState.create_details.title>
        ) => {
            state.create_details.title = action.payload;
        },
        setLoadingLinks: (
            state,
            action: PayloadAction<typeof initialState.ui.loading_links>
        ) => {
            state.ui.loading_links = action.payload;
        },
        setLinkCopied: (
            state,
            action: PayloadAction<typeof initialState.ui.link_copied>
        ) => {
