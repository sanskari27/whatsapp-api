...
const SchedulerSlice = createSlice({
    ...
    reducers: {
        ...
        setRecipientsFrom: (
            state,
            action: PayloadAction<typeof initialState.details.type>
        ) => {
        ...
        setBusinessAccount: (
            state,
            action: PayloadAction<typeof initialState.isBusinessAccount>
        ) => {
            state.isBusinessAccount = action.payload;
        },
        setRecipients: (
            state,
            action: PayloadAction<typeof initialState.recipients>
        ) => {
            state.recipients = action.payload;
        },
        setCSVFile: (
            state,
            action: PayloadAction<typeof initialState.details.csv_file>
        ) => {
            state.details.csv_file = action.payload;
        },
        setVariables: (
            state,
            action: PayloadAction<typeof initialState.details.variables>
        ) => {
            state.details.variables = action.payload;
        },
        setGroupRecipients: (
            state,
            action: PayloadAction<typeof initialState.details.group_ids>
        ) => {
            state.details.group_ids = action.payload;
        },
        setLabelRecipients: (
            state,
            action: PayloadAction<typeof initialState.details.label_ids>
        ) => {
        ...
        setMinDelay: (
            state,
            action: PayloadAction<typeof initialState.details.min_delay>
        ) => {
            state.details.min_delay = action.payload;
        },
        setMaxDelay: (
            state,
            action: PayloadAction<typeof initialState.details.max_delay>
        ) => {
            state.details.max_delay = action.payload;
        },
        setBatchSize: (
            state,
            action: PayloadAction<typeof initialState.details.batch_size>
        ) => {
            state.details.batch_size = action.payload;
        },
        setBatchDelay: (
            state,
            action: PayloadAction<typeof initialState.details.batch_delay>
        ) => {
            state.details.batch_delay = action.payload;
        },
        setStartTime: (
            state,
            action: PayloadAction<typeof initialState.details.startTime>
        ) => {
            state.details.startTime = action.payload;
        },
        setEndTime: (
            state,
            action: PayloadAction<typeof initialState.details.endTime>
        ) => {
        ...
        setCampaignLoading: (
            state,
            action: PayloadAction<typeof initialState.ui.campaignLoading>
        ) => {
