...
const ChatBotSlice = createSlice({
    ...
    reducers: {
        ...
        setChatBots: (
            state,
            action: PayloadAction<typeof initialState.all_chatbos>
        ) => {
            state.all_chatbos = action.payload;
        },
        setTrigger: (
            state,
            action: PayloadAction<typeof initialState.trigger>
        ) => {
        ...
        setRespondTo: (
            state,
            action: PayloadAction<typeof initialState.respond_to>
        ) => {
        ...
        setContactCards: (
            state,
            action: PayloadAction<typeof initialState.shared_contact_cards>
        ) => {
