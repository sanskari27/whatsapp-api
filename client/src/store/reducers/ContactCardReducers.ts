...
const ContactCardReducers = createSlice({
    ...
    reducers: {
        ...
        setContactList: (
            state,
            action: PayloadAction<typeof initialState.list>
        ) => {
            state.list = action.payload;
        },
        addContactCard: (
            state,
            action: PayloadAction<typeof initialState.selectedCard>
        ) => {
        ...
        findContactById: (
            state,
            action: PayloadAction<typeof initialState.selectedCard.id>
        ) => {
            state.selectedCard = state.list.find(
                (card) => card.id === action.payload
            )!;
        },
        setFirstName: (
            state,
            action: PayloadAction<typeof initialState.selectedCard.first_name>
        ) => {
            state.selectedCard.first_name = action.payload;
        },
        setMiddleName: (
            state,
            action: PayloadAction<typeof initialState.selectedCard.middle_name>
        ) => {
            state.selectedCard.middle_name = action.payload;
        },
        setLastName: (
            state,
            action: PayloadAction<typeof initialState.selectedCard.last_name>
        ) => {
            state.selectedCard.last_name = action.payload;
        },
        setTitle: (
            state,
            action: PayloadAction<typeof initialState.selectedCard.title>
        ) => {
        ...
        setEmailPersonal: (
            ...
            action: PayloadAction<
                typeof initialState.selectedCard.email_personal
            >
        ) => {
        ...
        setEmailWork: (
            state,
            action: PayloadAction<typeof initialState.selectedCard.email_work>
        ) => {
        ...
        setContactNumberPhone: (
            state,
            action: PayloadAction<
                typeof initialState.selectedCard.contact_details_phone
            >
        ) => {
        ...
        setContactNumberWork: (
            state,
            action: PayloadAction<
                typeof initialState.selectedCard.contact_details_work
            >
        ) => {
        ...
        removeContactNumberOther: (state, action: PayloadAction<number>) => {
            state.selectedCard.contact_details_other =
                state.selectedCard.contact_details_other?.filter(
        ...
        setLinks: (
            ...
            state.selectedCard.links![action.payload.index] =
                action.payload.url;
        },
        ...
        setCity: (
            state,
            action: PayloadAction<typeof initialState.selectedCard.city>
        ) => {
            state.selectedCard.city = action.payload;
        },
        setCountry: (
            state,
            action: PayloadAction<typeof initialState.selectedCard.country>
        ) => {
            state.selectedCard.country = action.payload;
        },
        setPincode: (
            state,
            action: PayloadAction<typeof initialState.selectedCard.pincode>
        ) => {
            state.selectedCard.pincode = action.payload;
        },
        setState: (
            state,
            action: PayloadAction<typeof initialState.selectedCard.state>
        ) => {
            state.selectedCard.state = action.payload;
        },
        setStreet: (
            state,
            action: PayloadAction<typeof initialState.selectedCard.street>
        ) => {
