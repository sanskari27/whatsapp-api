...
export default class LabelService {
    static async listLabels() {
        try {
            ...
            if (
                ...
                err.response?.data?.title === 'BUSINESS_ACCOUNT_REQUIRED'
            ) {
    ...
    static async fetchLabel(ids: string[], vcf_only = false) {
        try {
            ...
            downloadLink.download = 'Label Contacts.csv'; // Specify the filename
